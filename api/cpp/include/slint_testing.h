...
template<typename Component>
inline void send_keyboard_string(const Component *component, const slint::SharedString &str,
                                 bool pressed)
{
    cbindgen_private::send_keyboard_string(str, pressed, &component->m_window.window_handle());
}
